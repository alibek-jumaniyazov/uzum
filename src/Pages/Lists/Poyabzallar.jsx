            ...
            <div className="contents">
                <div className="elements">
                    ...
                    <Link to={'/barcha'} >  <p className="listItemstext bar"><i class="fa-solid fa-angle-left"></i> Barcha turkumlar</p> </Link>
                        <p className='listItemstext mainText'>Poyabzallar</p>
                        <p className="listItemstext">Poyabzal aksessuarlari</p>
                        <p className="listItemstext">Ayollar poyabzali</p>
                        <p className="listItemstext">Erkaklar poyabzali</p>
                        <p className="listItemstext">Qizlar uchun poyabzal</p>
                        <p className="listItemstext">Oʻgʻil bolalar uchun poyabzal</p>
                        <p className="listItemstext">Maxsus poyabzal</p>
                    </div>
